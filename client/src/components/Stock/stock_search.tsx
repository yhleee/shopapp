          ...
          <Row gutter={10}>
            <Col span={12}>
              <select className={cx('select-distance')} onChange={this.handleChange} defaultValue="0">
                <option className={cx('option')} value="0">전체</option>
                <option className={cx('option')} value="1">1km</option>
                <option className={cx('option')} value="3">3km</option>
                <option className={cx('option')} value="5">5km</option>
                <option className={cx('option')} value="10">10km</option>
                <option className={cx('option')} value="20">20km</option>
              </select>
            </Col>
            <Col span={12}>
              <input
